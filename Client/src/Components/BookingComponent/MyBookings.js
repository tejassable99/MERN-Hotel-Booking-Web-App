...
let uid;
   ...
   useEffect(() => {
    ...
    fetch(`https://mern-hotel-booking-web-app-git-main-tejas-projects-c8790610.vercel.app/getData/${uid}`)
    .then((res)=> res.json())
    ...
    //  console.log(Data)
      ...
      //   axios.delete(`http://localhost:9000/cancelBooking/${jkuid}/${jktotal}`)
      //     .then((res) => {
      //       console.log(res);
  ...
  return (
   ...
   <div>
      ...
      <div className="container-div">
        <h1 className='contact-headding'>My Bookings</h1>
