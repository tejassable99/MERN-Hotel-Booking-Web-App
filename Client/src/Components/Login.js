...
{usernameValidation && <Message color='red'>Invalid Username!!!</Message>} */}
    ...
    {signUpmsg==true?  <Message color='red'>Fill All Mandatory Fields</Message>:takenMsg==true?<Message color='red'>Username Already Taken!!!</Message>:usernameValidation==true?<Message color='red'>Invalid Username!!!("@" and "." is missing,e.g. j@gmail.com)</Message>: null}
      <Header as='h1' icon textAlign='center'>
        <Icon name="users" iconPosition="right" size='massive' color='blue' />
